        ...
        <div className={`nav  z-1 fixed top-0 left-0 w-full flex justify-center items-center ${isOpen ? 'open' : ''}`}>
            ...
            <div className="navbar w-full flex flex-col gap-0">
                ...
                <div className="navbar__bottom flex align-center justify-center items-center ">
                    <div className="container flex flex-col md:flex-row justify-between items-center pt-2 pb-2 sm:pt-3 sm:pb-3 md:pt-3 md:pb-3">
                        ...
                        <div className="navbar__bottom--right">
                            <ul className="flex flex-col md:flex-row list-none gap-1 md:gap-2 ">
                                ...
                                <li className="flex align-center items-center px-1 md:px-2 top-[-3px]">
                                    <a href="https://www.linkedin.com/in/oleksandr-petryshyn/"
                                       ...
                                       rel="noreferrer">
                                        <img className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" src={linkedinIcon} alt="Linkedin profile page icon"
                                ...
                                <li className="flex align-center items-center px-1 md:px-2"><a
                                    ...
                                    rel="noreferrer">
                                    <img className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" src={githubIcon} alt="Github profile page icon" title="Github profile page"/>
                                </a></li>
                            </ul>
                        </div>
                    </div>
