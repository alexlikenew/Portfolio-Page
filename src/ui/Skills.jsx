            ...
            <div className="container flex justify-center flex-col gap-10">
                ...
                <div className="w-full flex justify-center gap-12">
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        ...
                        <span className="opacity-40 text-sm">Javascript</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                        ...
                        <span className="opacity-40 text-sm">Typescript</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            <g fill="#61DAFB">
                        ...
                        <span className="opacity-40 text-sm">React</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            <path fill="#764abc"
                        ...
                        <span className="opacity-40 text-sm">Redux</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            <path
                        ...
                        <span className="opacity-40 text-sm">NextJS</span>
                    </div>
                    ...
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        ...
                        <span className="opacity-40 text-sm">Vite</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                        ...
                        <span className="opacity-40 text-sm">SASS</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            <path
                        ...
                        <span className="opacity-40 text-sm">Tailwind</span>
                    </div>
                    <div className="icon-container flex flex-col items-center justify-center gap-3 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                            <defs>
                        ...
                        <span className="opacity-40 text-sm">Bootstrap</span>
                    </div>
