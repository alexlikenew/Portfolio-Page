...
function LatestArticles({articlesCount}) {
    ...
    return (
        <div className="w-full mt-20 sm:mt-28 md:mt-32 lg:mt-40 mb-20 sm:mb-28 md:mb-32 lg:mb-50">
            <div className="container flex justify-center flex-col gap-6 sm:gap-8 md:gap-10">
                ...
                {isPending ? <div className="flex justify-center">Loading...</div> :
                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
