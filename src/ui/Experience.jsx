...
function Experience(props) {
    return (
        <div className="w-full justify-center pt-24 sm:pt-32 md:pt-40 lg:pt-60 pb-24 sm:pb-32 md:pb-40 lg:pb-60 relative">
            ...
            <div className="container container--1110 flex flex-col">
                <div className="flex items-center flex-col">
                    ...
                    <p className="opacity-70 mb-2 sm:mb-3 md:mb-4 text-center text-sm sm:text-base">I build modern, high-performance websites using the
                ...
                <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
                    <div className="flex gap-4 sm:gap-6 md:gap-8 items-center">
                        <img loading="lazy" className="w-[50px] sm:w-[60px] md:w-[75px]" src={argoniumImage} alt="Splentum company icon"
                             title="Splentum"/>
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs sm:text-sm mt-1 sm:mt-2">I work on the company’s proprietary CMS platform, contributing
                    ...
                    <div className="flex gap-4 sm:gap-6 md:gap-8 items-center">
                        <img loading="lazy" className="w-[50px] sm:w-[60px] md:w-[75px]" src={splentumImage} alt="Splentum company icon"
                             title="Splentum"/>
                        <div className="flex flex-col">
                            <span className="text-base sm:text-lg">Splentum Sp. z o. o.</span>
                            <p className="text-xs sm:text-sm">Mar 2016 – Oct 2017 |
                                                              Junior Front-End Developer </p>
                            <p className="text-xs sm:text-sm mt-1 sm:mt-2">I supported the design and development of a web application for
                    ...
                    <div className="flex gap-4 sm:gap-6 md:gap-8 items-center">
                        <img loading="lazy" className="w-[50px] sm:w-[60px] md:w-[75px]" src={netiImage} alt="Neti company icon" title="Neti"/>
                        <div className="flex flex-col">
                            ...
                            <p className="text-xs sm:text-sm mt-1 sm:mt-2">During my internship at Neti, I worked on front-end features and
                                                                           interactive scripts,
            ...
            <div className="container container--1110 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-24 lg:gap-36 mt-16 sm:mt-20 md:mt-32 lg:mt-50">
                <div className="w-full flex flex-col">
                    <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-bold relative inline-block text-white mb-8 sm:mb-12 md:mb-14 lg:mb-18">
                        Education
                ...
                <div className="w-full flex justify-center items-center">
                    <img loading="lazy" src={education} className="w-full h-auto max-h-[400px] sm:max-h-[500px] object-cover"
