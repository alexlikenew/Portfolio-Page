...
function Follow({classes}) {
    return (
        <div
            className={`${classes} rounded-[10px] mt-4 sm:mt-6 md:mt-8 flex flex-col pt-2 pb-2 sm:pt-3 sm:pb-3 md:pt-4 md:pb-4 gap-2 sm:gap-3 md:gap-4 justify-center items-center`}>
